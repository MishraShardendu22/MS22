...
import { Search, Code2, ExternalLink, Github, Play, ChevronLeft, ChevronRight, ArrowUpRight, Filter, X } from 'lucide-react'
  ...
  const filteredProjects = useMemo(() => {
    return projects.filter(project => {
      const matchesSearch = searchQuery === '' || 
        ...
        project.small_description.toLowerCase().includes(searchQuery.toLowerCase()) ||
        ...
        <div className="container mx-auto px-4 py-10 relative">
          <div className="max-w-7xl mx-auto">
            <h1 className="text-4xl md:text-5xl font-black text-white mb-3 tracking-tight">
              My <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 animate-gradient">Projects</span>
            </h1>
            ...
            <div className="relative group animate-fadeIn">
              ...
              <div className="relative p-5 bg-gray-900/90 backdrop-blur-xl border border-gray-800/50 rounded-xl space-y-3 shadow-2xl">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-sm font-bold text-white">Filter by Technology</h3>
            ...
            {selectedSkills.length > 0 && (
              <div className="flex items-center gap-1.5 px-4 py-2 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-500/30 rounded-lg">
                ...
                <span className="text-cyan-400 font-semibold">
                  Filtered by {selectedSkills.length} {selectedSkills.length !== 1 ? 'technologies' : 'technology'}
                </span>
              </div>
            )}
          </div>
...
function ProjectCard({ project, index }: ProjectCardProps) {
  const projectId = project._id || project.id || project.inline?.id || project.inline?._id || ''
