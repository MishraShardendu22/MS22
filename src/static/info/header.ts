import { Education, Introduction, SocialLink } from "./types";
...
export const myIntro: Introduction = {
    "name" : "Shardendu Sankrit Mishra",
    "role" : "Software Engineer and AI/ML Enthusiast",
    "about": "I am a Software Engineer, I work with Linux, Git, Web Technologies, Cloud Platforms and AI/ML. I absolutely love Engineering solutions for problems.",
}
