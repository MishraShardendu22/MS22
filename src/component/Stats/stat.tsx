...
export const StatsDisplay = ({ github, stars, leetcode, topRepos, commits, calendar }: StatsDisplayProps) => {
  ...
  return (
    <section className="relative py-12 px-4 sm:px-6 md:px-8 bg-gradient-to-b from-transparent via-gray-950/50 to-transparent overflow-hidden">
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="text-center mb-8">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 bg-clip-text text-transparent mb-4">
            Coding Statistics
          </h2>
