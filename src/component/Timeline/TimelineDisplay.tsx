  ...
  return (
    <section className="relative py-8 sm:py-12 md:py-16 lg:py-20 px-4 sm:px-6 md:px-8 bg-linear-to-b from-transparent via-gray-950/50 to-transparent overflow-hidden">
      <div className="absolute inset-0 pointer-events-none will-change-auto">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-violet-500/8 rounded-full blur-2xl"></div>
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-blue-500/8 rounded-full blur-2xl"></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-125 h-125 bg-purple-500/5 rounded-full blur-2xl"></div>
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="text-center mb-20 space-y-6">
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold">
            <span className="bg-linear-to-r from-violet-400 via-blue-400 to-purple-400 bg-clip-text text-transparent drop-shadow-[0_0_30px_rgba(6,182,212,0.3)]">
              Experience Timeline
            </span>
          </h2>
          ...
          >
            ...
            >
              <div className="relative mb-8" style={{ height: "120px" }}>
                ...
                <div className="absolute top-16 left-0 right-0 h-1 bg-linear-to-r from-violet-500/30 via-blue-500/30 to-purple-500/30 rounded-full shadow-lg shadow-violet-500/20" />
              </div>
