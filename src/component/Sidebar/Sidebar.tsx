    ...
    <>
      ...
      >
        ...
        <div className="h-20 flex items-center justify-center px-5 border-b border-gray-800/50">
          <div
            className={`flex flex-col items-center justify-center transition-all duration-300 ${isExpanded ? "opacity-100" : "opacity-100"}`}
          >
            {isExpanded ? (
        ...
        <div
          className={`px-4 py-4 border-t border-gray-800/50 transition-opacity duration-300 ${isExpanded ? "opacity-100" : "opacity-0"}`}
        >
