...
export const HeroSection = () => {
  ...
  useEffect(() => {
    ...
    if (educationCards.length > 0) {
      tl.add(Array.from(educationCards), {
        translateY: [30, 0],
        opacity: [0, 1],
        duration: 500,
        delay: stagger(80),
  ...
  return (
    <section className="relative w-full min-h-screen px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-12 md:py-16 overflow-hidden">
      {/* Background Elements */}
      <BackgroundElements />
