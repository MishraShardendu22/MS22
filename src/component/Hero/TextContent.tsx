...
import { SocialLinks, myIntro } from '@/static/info/header';
...
export const TextContent = () => {
  return (
    <div className="lg:col-span-7 text-center lg:text-left space-y-4 md:space-y-6 relative z-10 order-2 lg:order-1">
      <h1
        className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-9xl font-black bg-linear-to-r from-white via-cyan-100 to-cyan-400 bg-clip-text text-transparent leading-[1.1] wrap-break-word"
      >
        {myIntro.name}
      </h1>
      ...
      <p
        className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl text-transparent bg-linear-to-r from-cyan-400 to-blue-400 bg-clip-text font-semibold"
      >
        {myIntro.role}
      </p>

      <p
        className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl text-gray-300 leading-relaxed max-w-4xl mx-auto lg:mx-0"
      >
        ...
        <span className="text-cyan-400 font-semibold">AI/ML</span>. I absolutely love Engineering solutions for problems.
      </p>
